...
public class PlayerCursor : MonoBehaviour
{
    ...
    [SerializeField] private GameObject cur1 = null;
    [SerializeField] private GameObject cur2 = null;
    ...
    void Update()
    {
        ...
        if (cursor01Changed) { Cursor1.SetActive(true); }
        else { Cursor1.SetActive(false); }
